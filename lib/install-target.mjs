...
export function installDoctrineIntoTarget(targetRoot, doctrinePackage, force) {
  ...
  const agentsSectionPath = resolve(doctrinePackage.packageRoot, normalizedAgentsSection);
  if (!agentsSectionPath.startsWith(doctrinePackage.packageRoot) || !existsSync(agentsSectionPath)) {
